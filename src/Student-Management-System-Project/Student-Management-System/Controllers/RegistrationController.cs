...
namespace Student_Management_System.Controllers
{
    public class RegistrationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,CNIC,CourseID,BatchID,Contact")] Registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,CNIC,CourseID,BatchID,Contact")] Registration registration)
        {
            if (ModelState.IsValid)
            {
